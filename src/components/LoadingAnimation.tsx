  ...
  return (
    <div className="flex flex-col items-center justify-center p-8">
      <div className="relative w-24 h-24 mb-8">
        ...
        <div className="absolute inset-0 border-4 border-brand-500 rounded-full border-t-transparent animate-spin-slow"></div>
      ...
      <div className="w-full max-w-md bg-gray-200 rounded-full h-2.5 mb-4 overflow-hidden">
        <div className="bg-brand-500 h-2.5 rounded-full animate-pulse-slow w-full"></div>
      </div>
